...
export default async function LandingPage() {
  ...
  // If user is authenticated, redirect to bookmarks
  if (!error && data?.claims) {
    redirect("/bookmarks");
  }

  return (
    <main className="min-h-screen flex flex-col bg-gradient-to-br from-background via-background to-muted/20">
          ...
          <div className="flex flex-col items-center justify-center gap-6 pt-4">
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <Button
                asChild
                size="lg"
                className="text-base px-8 py-6 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary shadow-lg shadow-primary/25 transition-all duration-200 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5"
              >
      ...
      {/* Features Section */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-muted/20 via-muted/30 to-background">
      ...
      <section className="py-16 md:py-24 relative">
        <div className="max-w-4xl mx-auto px-4">
          <div className="relative bg-gradient-to-br from-background via-background to-muted/10 border border-border/50 rounded-2xl p-8 md:p-12 shadow-lg backdrop-blur-sm">
            {/* Subtle decoration */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-primary/5 to-transparent rounded-2xl" />
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-primary/5 to-transparent rounded-2xl" />
      ...
      {/* Footer */}
      <footer className="border-t border-border/50 bg-gradient-to-t from-muted/40 to-muted/20 backdrop-blur-sm">
